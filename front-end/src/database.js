const database = {
  users: [
    ...
    },//balance 10000  debut 390 credit 200
      {
      id: "2",
      name: "Ahmed",
...
//find() pour trouver l’utilisateur par son id, puis accéder à son wallet pour trouvé la liste de ses bénéficiaires
}
...
//find()pour trouver l’utili par son id,puis accéder à son wallet,ensuite trouver le bénéfi par id et le retourner
}
